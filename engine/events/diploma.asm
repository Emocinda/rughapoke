...
DiplomaText:
	db CIRCLE_TILE_ID, "Diplomo", CIRCLE_TILE_ID, "@"
...
DiplomaCongrats:
	db   "Gratulon!"				;	Congrats! This"
	next "Tiu diplomo"				; 	"diploma certifies"
	next "asertas ke vi"			;	that you have"
	next "plenumis vian"			;	completed your"
	next "<PK>DEKSON.@"
