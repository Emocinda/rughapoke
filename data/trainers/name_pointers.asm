...
.YoungsterName:     db "BUBO@"    			; 	"YOUNGSTER"
.BugCatcherName:    db "SKOLTO@" 			; 	"BUG CATCHER"
.LassName:          db "KNABINO@"    		; 	"LASS"
.JrTrainerMName:    db "TREJNISTETO♂@"		;	"JR.TRAINER♂@"
.JrTrainerFName:    db "TREJNISTETO♀@"		;	"JR.TRAINER♀@"
.PokemaniacName:    db "<PK>ŜATULO@"		;	POKéMANIAC"
.SuperNerdName:     db "FAKULO@"			;	SUPER NERD@"
...
.BlackbeltName:     db "NIGRZONULO@"		; 	BLACKBELT@"
